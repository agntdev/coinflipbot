...
Implement the /start command handler in src/handlers/start.ts. The handler should reply with a short welcome message and list of available commands. Add a test spec to tests/specs/start.json and register the command in tests/commands.json.
