...
Implement the /help command handler in src/handlers/help.ts. The handler should reply with a short list of available commands and one-line descriptions. Add a test spec to tests/specs/help.json and register the command in tests/commands.json.
